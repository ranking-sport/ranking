...
def recall_at_k(pred_indices, gold_top_k_indices, k):
    ...
    recall = len(top_k_preds.intersection(set(gold_top_k_indices))) / k
    return recall

# === Updated Reward Function (Recall) ===
...
for epoch in range(5):
    ...
    save_path = f"/scratch/nitishk_iitp/Model/Llama-3.2-1B-r/ppo_epoch{epoch}"
